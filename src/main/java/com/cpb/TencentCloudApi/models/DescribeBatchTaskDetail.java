...
import com.tencentcloudapi.dnspod.v20210323.models.BatchRecordInfo;
...
public class DescribeBatchTaskDetail extends AbstractModel {
    ...
    @Expose
    private com.tencentcloudapi.dnspod.v20210323.models.BatchRecordInfo[] RecordList;
     ...
     * 注意：此字段可能返回 null，表示取不到有效值。
     */
    public com.tencentcloudapi.dnspod.v20210323.models.BatchRecordInfo[] getRecordList() {
     ...
     *                   注意：此字段可能返回 null，表示取不到有效值。
     */
    public void setRecordList(com.tencentcloudapi.dnspod.v20210323.models.BatchRecordInfo[] RecordList) {
     ...
     */
    public DescribeBatchTaskDetail(DescribeBatchTaskDetail source) {
        if (source.RecordList != null) {
            this.RecordList = new com.tencentcloudapi.dnspod.v20210323.models.BatchRecordInfo[source.RecordList.length];
