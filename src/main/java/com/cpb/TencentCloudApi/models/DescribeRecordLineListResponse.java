...
import com.tencentcloudapi.dnspod.v20210323.models.LineGroupInfo;
...
public class DescribeRecordLineListResponse extends AbstractModel {
    ...
    @Expose
    private com.tencentcloudapi.dnspod.v20210323.models.LineInfo[] LineList;
    ...
    @Expose
    private com.tencentcloudapi.dnspod.v20210323.models.LineGroupInfo[] LineGroupList;
     ...
     */
    public com.tencentcloudapi.dnspod.v20210323.models.LineInfo[] getLineList() {
     ...
     * @param LineList 线路列表。
     */
    public void setLineList(com.tencentcloudapi.dnspod.v20210323.models.LineInfo[] LineList) {
     ...
     */
    public com.tencentcloudapi.dnspod.v20210323.models.LineGroupInfo[] getLineGroupList() {
     ...
     */
    public void setLineGroupList(com.tencentcloudapi.dnspod.v20210323.models.LineGroupInfo[] LineGroupList) {
    ...
    public DescribeRecordLineListResponse(DescribeRecordLineListResponse source) {
        if (source.LineList != null) {
            this.LineList = new com.tencentcloudapi.dnspod.v20210323.models.LineInfo[source.LineList.length];
            for (int i = 0; i < source.LineList.length; i++) {
                this.LineList[i] = new LineInfo(source.LineList[i]);
            }
        }
        if (source.LineGroupList != null) {
            this.LineGroupList = new com.tencentcloudapi.dnspod.v20210323.models.LineGroupInfo[source.LineGroupList.length];
